...
<title>Doctor Accepted List</title>
</head>
<body>
<i><center><h1><b><u>Doctor Accepted List</u></b></h1></center></i>
...
<td width="120">ID Proof</td>
 ...
 <?php
      $selQry="select * from tbl_doctor r inner join tbl_place p on r.place_id=p.place_id inner join tbl_district dt on dt.district_id=p.district_id inner join tbl_doctortype tp on tp.doctortype_id=r.doctortype_id where r.doctor_status=1";
