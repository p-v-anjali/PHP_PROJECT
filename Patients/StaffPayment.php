...
<body>
	...
	<div class="wrapper">
		...
		<form method="POST">
            ...
            <div class="input-group">
				<div class="input-box">
					<input class="name" type="tel" id="txtcardno" name="txtcardno" required value="<?php echo $_GET["fees"]?>">
					<i class="fa fa-credit-card icon" aria-hidden="true"></i>
				</div>
			</div>
			<div class="input-group">
	...
	{
		$up="update tbl_staffrequest set staffrequest_status=5 where staffrequest_id='".$_GET["pid"]."'";
		$con->query($up);
		//echo $up;
