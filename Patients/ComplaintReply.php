...
<form id="form1" name="form1" method="post" action="">
 <center> <table width="765" height="106" border="1">
    <tr>
     ...
     <?php
	$selectQry="select * from tbl_complaint c inner join tbl_patient p on c.patient_id=p.patient_id inner join tbl_complainttype ct on ct.complainttype_id=c.complainttype_id where complaint_status='1'";
	//echo $selectQry;
