...
<title>Patient Request Rejected List</title>
</head>
...
<table border="1" cellpadding="11" align="center">
 ...
 <?php
      $selQry="SELECT * FROM tbl_doctorrequest dr INNER JOIN tbl_patient p ON dr.patient_id=p.patient_id INNER JOIN tbl_place c ON p.place_id=c.place_id INNER JOIN tbl_district d ON d.district_id=c.district_id where dr.doctorrequest_status='2'";
